...
class Menwatches extends StatefulWidget {
  const Menwatches({super.key});

  @override
  State<Menwatches> createState() => _MenwatchesState();
}

class _MenwatchesState extends State<Menwatches> {
  ...
  Future<void> _fetchData() async {
    try  
{
      bagModel = await _apiProvider.getwatches();
       if(mounted)setState(() {
        isLoading = false;
