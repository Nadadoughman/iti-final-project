...
class FragPage extends StatefulWidget {
  const FragPage({super.key});

  @override
  State<FragPage> createState() => _FragPageState();
}

class _FragPageState extends State<FragPage> {
  ...
  Future<void> _fetchData() async {
    try  
{
      bagModel = await _apiProvider.getfrag();
           if (mounted)setState(() {
        isLoading = false;
